            ...
            {props.transactionList.map((transaction) =>{
                if(props.selectedFilter[0] === 'Category'){
                    if(props.selectedFilter[1] === 'All'){
                        return <TransactionListEntry  key={transaction.id} transaction={transaction}/>
                    }else if(props.selectedFilter[1] === 'Debit' && transaction.transactionType === 'Debit'){
                        return <TransactionListEntry  key={transaction.id} transaction={transaction}/>
                    }else if(props.selectedFilter[1] === 'Credit' && transaction.transactionType === 'Credit'){
                        return <TransactionListEntry  key={transaction.id} transaction={transaction}/>
